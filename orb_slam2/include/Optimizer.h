...
public:
    ...
    void static LocalBundleAdjustmentNavState(
            KeyFrame *pKF,
    ...
    Vector3d static OptimizeInitialGyroBias(const std::vector<KeyFrame*> &vLocalKeyFrames, const cv::Mat& Rcb_Mat);
    ...
    void static OptimizeEssentialGraphForMonoVI(Map* pMap, KeyFrame* pLoopKF, KeyFrame* pCurKF,
                                       const LoopClosing::KeyFrameAndPose &NonCorrectedSim3,
                                       const LoopClosing::KeyFrameAndPose &CorrectedSim3,
                                       const map<KeyFrame *, set<KeyFrame *> > &LoopConnections,
                                       const bool &bFixScale, const cv::Mat& Tbc_Mat,
                                       LoopClosing* pLC=NULL
                                       );
