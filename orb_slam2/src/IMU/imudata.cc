...
double IMUData::_accBiasRw2 = 3.0e-3*3.0e-3/**10*/;  /// corrected by Huang weibo
...
Matrix3d IMUData::_accMeasCov = Matrix3d::Identity()*2.0e-3*2.0e-3/0.005;       /// corrected by Huang weibo

// covariance of bias random walk
Matrix3d IMUData::_gyrBiasRWCov = Matrix3d::Identity()*IMUData::_gyrBiasRw2;     // sigma_gw * sigma_gw * dt, ~2e-12
Matrix3d IMUData::_accBiasRWCov = Matrix3d::Identity()*IMUData::_accBiasRw2;     // sigma_aw * sigma_aw * dt, ~4.5e-8
